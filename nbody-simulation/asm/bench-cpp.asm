...
0000000000010990 <deregister_tm_clones>:
   10990:	d503201f 	nop
   10994:	10105f60 	adr	x0, 31580 <__TMC_END__>
   10998:	d503201f 	nop
   1099c:	10105f21 	adr	x1, 31580 <__TMC_END__>
...
00000000000109c0 <register_tm_clones>:
   109c0:	d503201f 	nop
   109c4:	10105de0 	adr	x0, 31580 <__TMC_END__>
   109c8:	d503201f 	nop
   109cc:	10105da1 	adr	x1, 31580 <__TMC_END__>
...
0000000000010a54 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_>:
   ...
   10b28:	540011c8 	b.hi	10d60 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x30c>  // b.pmore
   ...
   10b40:	54000063 	b.cc	10b4c <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0xf8>  // b.lo, b.ul, b.last
   10b44:	aa0b03ee 	mov	x14, x11
   10b48:	1400005a 	b	10cb0 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x25c>
   ...
   10ca0:	54fff681 	b.ne	10b70 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x11c>  // b.any
   10ca4:	eb0d01df 	cmp	x14, x13
   10ca8:	540005c0 	b.eq	10d60 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x30c>  // b.none
   ...
   10d5c:	54fffc01 	b.ne	10cdc <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x288>  // b.any
   ...
   10d74:	54000180 	b.eq	10da4 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x350>  // b.none
   ...
   10d9c:	54ffec89 	b.ls	10b2c <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0xd8>  // b.plast
   10da0:	17fffff0 	b	10d60 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x30c>
   ...
   10e08:	54fffd81 	b.ne	10db8 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x364>  // b.any
   ...
   10e5c:	54fffda1 	b.ne	10e10 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x3bc>  // b.any
   10e60:	294127e8 	ldp	w8, w9, [sp, #8]
   10e64:	11000529 	add	w9, w9, #0x1
   10e68:	6b08013f 	cmp	w9, w8
   10e6c:	54ffe321 	b.ne	10ad0 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x7c>  // b.any
...
0000000000010e98 <main>:
   ...
   10f30:	b4001893 	cbz	x19, 11240 <main+0x3a8>
   10f34:	b4001874 	cbz	x20, 11240 <main+0x3a8>
   10f38:	b4001855 	cbz	x21, 11240 <main+0x3a8>
   10f3c:	b4001836 	cbz	x22, 11240 <main+0x3a8>
   10f40:	b4001817 	cbz	x23, 11240 <main+0x3a8>
   10f44:	b40017f8 	cbz	x24, 11240 <main+0x3a8>
   10f48:	b40017d9 	cbz	x25, 11240 <main+0x3a8>
   10f4c:	b40017ba 	cbz	x26, 11240 <main+0x3a8>
   10f50:	d28fe5a9 	mov	x9, #0x7f2d                	// #32557
   10f54:	90ffff8d 	adrp	x13, 0 <__abi_tag-0x2c4>
   10f58:	f2a992a9 	movk	x9, #0x4c95, lsl #16
   10f5c:	aa0003fc 	mov	x28, x0
   10f60:	f2de85a9 	movk	x9, #0xf42d, lsl #32
   10f64:	aa1f03e8 	mov	x8, xzr
   10f68:	f2eb0a29 	movk	x9, #0x5851, lsl #48
   10f6c:	5280002c 	mov	w12, #0x1                   	// #1
   10f70:	b24003ea 	orr	x10, xzr, #0x1
   10f74:	d2e7940b 	mov	x11, #0x3ca0000000000000    	// #4368491638549381120
   10f78:	1e7e1000 	fmov	d0, #-1.000000000000000000e+00
   10f7c:	1e601001 	fmov	d1, #2.000000000000000000e+00
   10f80:	fd43c1a2 	ldr	d2, [x13, #1920]
   10f84:	1e6c1003 	fmov	d3, #5.000000000000000000e-01
   10f88:	9b09298c 	madd	x12, x12, x9, x10
   10f8c:	9e670167 	fmov	d7, x11
   10f90:	d34bfd8d 	lsr	x13, x12, #11
   10f94:	9b09298e 	madd	x14, x12, x9, x10
   10f98:	9e6301a4 	ucvtf	d4, x13
   10f9c:	9b0929cd 	madd	x13, x14, x9, x10
   10fa0:	d34bfdce 	lsr	x14, x14, #11
   10fa4:	9b0929ac 	madd	x12, x13, x9, x10
   10fa8:	d34bfdad 	lsr	x13, x13, #11
   10fac:	9e6301d1 	ucvtf	d17, x14
   10fb0:	1e670884 	fmul	d4, d4, d7
   10fb4:	d34bfd8f 	lsr	x15, x12, #11
   10fb8:	9b092990 	madd	x16, x12, x9, x10
   10fbc:	9e6301b3 	ucvtf	d19, x13
   10fc0:	d37df10d 	lsl	x13, x8, #3
   10fc4:	91000508 	add	x8, x8, #0x1
   10fc8:	9e6301e5 	ucvtf	d5, x15
   10fcc:	1e670a31 	fmul	d17, d17, d7
   10fd0:	9b092a0f 	madd	x15, x16, x9, x10
   10fd4:	d34bfe10 	lsr	x16, x16, #11
   10fd8:	1f410084 	fmadd	d4, d4, d1, d0
   10fdc:	f117711f 	cmp	x8, #0x5dc
   10fe0:	9b0929ec 	madd	x12, x15, x9, x10
   10fe4:	d34bfdef 	lsr	x15, x15, #11
   10fe8:	9e630210 	ucvtf	d16, x16
   10fec:	1e6708a5 	fmul	d5, d5, d7
   10ff0:	d34bfd91 	lsr	x17, x12, #11
   10ff4:	fc2d6a64 	str	d4, [x19, x13]
   10ff8:	9e6301f2 	ucvtf	d18, x15
   10ffc:	1f410231 	fmadd	d17, d17, d1, d0
   11000:	9e630226 	ucvtf	d6, x17
   11004:	1e670a10 	fmul	d16, d16, d7
   11008:	1f4100a5 	fmadd	d5, d5, d1, d0
   1100c:	fc2d6a91 	str	d17, [x20, x13]
   11010:	1e670a52 	fmul	d18, d18, d7
   11014:	1e6708c6 	fmul	d6, d6, d7
   11018:	1e670a67 	fmul	d7, d19, d7
   1101c:	1f410210 	fmadd	d16, d16, d1, d0
   11020:	1e6208a4 	fmul	d4, d5, d2
   11024:	1f410252 	fmadd	d18, d18, d1, d0
   11028:	1f4100c6 	fmadd	d6, d6, d1, d0
   1102c:	1f4100e7 	fmadd	d7, d7, d1, d0
   11030:	1e620a05 	fmul	d5, d16, d2
   11034:	fc2d6ac4 	str	d4, [x22, x13]
   11038:	fc2d6aa7 	str	d7, [x21, x13]
   1103c:	1e620a47 	fmul	d7, d18, d2
   11040:	1e60c0c6 	fabs	d6, d6
   11044:	fc2d6ae5 	str	d5, [x23, x13]
   11048:	fc2d6b07 	str	d7, [x24, x13]
   1104c:	1e6328c4 	fadd	d4, d6, d3
   11050:	fc2d6b24 	str	d4, [x25, x13]
   11054:	54fff9a1 	b.ne	10f88 <main+0xf0>  // b.any
   11058:	528000a0 	mov	w0, #0x5                   	// #5
   1105c:	aa1303e1 	mov	x1, x19
   11060:	aa1403e2 	mov	x2, x20
   11064:	aa1503e3 	mov	x3, x21
   11068:	aa1603e4 	mov	x4, x22
   1106c:	aa1703e5 	mov	x5, x23
   11070:	aa1803e6 	mov	x6, x24
   11074:	aa1903e7 	mov	x7, x25
   11078:	a900f3fb 	stp	x27, x28, [sp, #8]
   1107c:	f90003fa 	str	x26, [sp]
   11080:	97fffe75 	bl	10a54 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_>
   11084:	910083e1 	add	x1, sp, #0x20
   11088:	52800020 	mov	w0, #0x1                   	// #1
   1108c:	940000a9 	bl	11330 <clock_gettime@plt>
   11090:	fd4017e0 	ldr	d0, [sp, #40]
   11094:	aa1b03e8 	mov	x8, x27
   11098:	52803200 	mov	w0, #0x190                 	// #400
   1109c:	aa1303e1 	mov	x1, x19
   110a0:	aa1403e2 	mov	x2, x20
   110a4:	aa1503e3 	mov	x3, x21
   110a8:	aa1603e4 	mov	x4, x22
   110ac:	aa1703e5 	mov	x5, x23
   110b0:	aa1803e6 	mov	x6, x24
   110b4:	aa1903e7 	mov	x7, x25
   110b8:	f94013fb 	ldr	x27, [sp, #32]
   110bc:	5e61d808 	scvtf	d8, d0
   110c0:	f81f83bc 	stur	x28, [x29, #-8]
   110c4:	a900f3e8 	stp	x8, x28, [sp, #8]
   110c8:	aa0803fc 	mov	x28, x8
   110cc:	f90003fa 	str	x26, [sp]
   110d0:	97fffe61 	bl	10a54 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_>
   110d4:	910083e1 	add	x1, sp, #0x20
   110d8:	52800020 	mov	w0, #0x1                   	// #1
   110dc:	94000095 	bl	11330 <clock_gettime@plt>
   110e0:	fd4017e0 	ldr	d0, [sp, #40]
   110e4:	2f00e401 	movi	d1, #0x0
   110e8:	f94013e8 	ldr	x8, [sp, #32]
   110ec:	9285dbe9 	mov	x9, #0xffffffffffffd120    	// #-12000
   110f0:	5e61d800 	scvtf	d0, d0
   110f4:	8b09026a 	add	x10, x19, x9
   110f8:	8b09028b 	add	x11, x20, x9
   110fc:	8b0902ac 	add	x12, x21, x9
   11100:	3dcbb942 	ldr	q2, [x10, #12000]
   11104:	3dcbb963 	ldr	q3, [x11, #12000]
   11108:	3dcbbd44 	ldr	q4, [x10, #12016]
   1110c:	8b0902ca 	add	x10, x22, x9
   11110:	3dcbbd65 	ldr	q5, [x11, #12016]
   11114:	8b0902eb 	add	x11, x23, x9
   11118:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   1111c:	3dcbb983 	ldr	q3, [x12, #12000]
   11120:	4e65d484 	fadd	v4.2d, v4.2d, v5.2d
   11124:	3dcbbd85 	ldr	q5, [x12, #12016]
   11128:	8b09030c 	add	x12, x24, x9
   1112c:	b1008129 	adds	x9, x9, #0x20
   11130:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   11134:	3dcbb943 	ldr	q3, [x10, #12000]
   11138:	4e65d484 	fadd	v4.2d, v4.2d, v5.2d
   1113c:	3dcbbd45 	ldr	q5, [x10, #12016]
   11140:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   11144:	3dcbb963 	ldr	q3, [x11, #12000]
   11148:	4e65d484 	fadd	v4.2d, v4.2d, v5.2d
   1114c:	3dcbbd65 	ldr	q5, [x11, #12016]
   11150:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   11154:	3dcbb983 	ldr	q3, [x12, #12000]
   11158:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   1115c:	4e65d483 	fadd	v3.2d, v4.2d, v5.2d
   11160:	5e180444 	mov	d4, v2.d[1]
   11164:	1e622821 	fadd	d1, d1, d2
   11168:	3dcbbd82 	ldr	q2, [x12, #12016]
   1116c:	4e62d462 	fadd	v2.2d, v3.2d, v2.2d
   11170:	1e642821 	fadd	d1, d1, d4
   11174:	5e180443 	mov	d3, v2.d[1]
   11178:	1e622821 	fadd	d1, d1, d2
   1117c:	1e632821 	fadd	d1, d1, d3
   11180:	54fffba1 	b.ne	110f4 <main+0x25c>  // b.any
   11184:	d2d09009 	mov	x9, #0x848000000000        	// #145685290680320
   11188:	9e620104 	scvtf	d4, x8
   1118c:	f2e825c9 	movk	x9, #0x412e, lsl #48
   11190:	f0ffff60 	adrp	x0, 0 <__abi_tag-0x2c4>
   11194:	911e2000 	add	x0, x0, #0x788
   11198:	9e670122 	fmov	d2, x9
   1119c:	d2c80009 	mov	x9, #0x400000000000        	// #70368744177664
   111a0:	f2e811e9 	movk	x9, #0x408f, lsl #48
   111a4:	1e621903 	fdiv	d3, d8, d2
   111a8:	9e670125 	fmov	d5, x9
   111ac:	1e621800 	fdiv	d0, d0, d2
   111b0:	9e620362 	scvtf	d2, x27
   111b4:	1f450c42 	fmadd	d2, d2, d5, d3
   111b8:	1f450080 	fmadd	d0, d4, d5, d0
   111bc:	1e623800 	fsub	d0, d0, d2
   111c0:	94000054 	bl	11310 <printf@plt>
   111c4:	aa1303e0 	mov	x0, x19
   111c8:	94000056 	bl	11320 <free@plt>
   111cc:	aa1403e0 	mov	x0, x20
   111d0:	94000054 	bl	11320 <free@plt>
   111d4:	aa1503e0 	mov	x0, x21
   111d8:	94000052 	bl	11320 <free@plt>
   111dc:	aa1603e0 	mov	x0, x22
   111e0:	94000050 	bl	11320 <free@plt>
   111e4:	aa1703e0 	mov	x0, x23
   111e8:	9400004e 	bl	11320 <free@plt>
   111ec:	aa1803e0 	mov	x0, x24
   111f0:	9400004c 	bl	11320 <free@plt>
   111f4:	aa1903e0 	mov	x0, x25
   111f8:	9400004a 	bl	11320 <free@plt>
   111fc:	aa1a03e0 	mov	x0, x26
   11200:	94000048 	bl	11320 <free@plt>
   11204:	aa1c03e0 	mov	x0, x28
   11208:	94000046 	bl	11320 <free@plt>
   1120c:	f85f83a0 	ldur	x0, [x29, #-8]
   11210:	94000044 	bl	11320 <free@plt>
   11214:	2a1f03f3 	mov	w19, wzr
   11218:	2a1303e0 	mov	w0, w19
   1121c:	fd401be8 	ldr	d8, [sp, #48]
   11220:	a9494ff4 	ldp	x20, x19, [sp, #144]
   11224:	a94857f6 	ldp	x22, x21, [sp, #128]
   11228:	a9475ff8 	ldp	x24, x23, [sp, #112]
   1122c:	a94667fa 	ldp	x26, x25, [sp, #96]
   11230:	a9456ffc 	ldp	x28, x27, [sp, #80]
   11234:	a9447bfd 	ldp	x29, x30, [sp, #64]
   11238:	910283ff 	add	sp, sp, #0xa0
   1123c:	d65f03c0 	ret
   11240:	90000088 	adrp	x8, 21000 <memset@plt+0xfcb0>
   11244:	d503201f 	nop
   11248:	70f7aae0 	adr	x0, 7a7 <_IO_stdin_used+0x37>
   1124c:	52800241 	mov	w1, #0x12                  	// #18
   11250:	52800022 	mov	w2, #0x1                   	// #1
   11254:	52800033 	mov	w19, #0x1                   	// #1
   11258:	f942b508 	ldr	x8, [x8, #1384]
   1125c:	f9400103 	ldr	x3, [x8]
   11260:	94000038 	bl	11340 <fwrite@plt>
   11264:	17ffffed 	b	11218 <main+0x380>

Disassembly of section .init:

0000000000011268 <_init>:
   11268:	d503201f 	nop
   1126c:	a9bf7bfd 	stp	x29, x30, [sp, #-16]!
   11270:	910003fd 	mov	x29, sp
   11274:	97fffdc0 	bl	10974 <call_weak_fn>
   11278:	a8c17bfd 	ldp	x29, x30, [sp], #16
   1127c:	d65f03c0 	ret

Disassembly of section .fini:

0000000000011280 <_fini>:
   11280:	d503201f 	nop
   11284:	a9bf7bfd 	stp	x29, x30, [sp, #-16]!
   11288:	910003fd 	mov	x29, sp
   1128c:	a8c17bfd 	ldp	x29, x30, [sp], #16
   11290:	d65f03c0 	ret
...
00000000000112a0 <abort@plt-0x20>:
   ...
   112a8:	f942ca11 	ldr	x17, [x16, #1424]
   112ac:	91164210 	add	x16, x16, #0x590
